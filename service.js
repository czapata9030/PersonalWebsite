...
function darkmodeS() {
        var text = document.getElementById("textQ-1");
        text.classList.toggle("dark-background");
        var text = document.getElementById("textQ-2");
        text.classList.toggle("dark-background");
        ...
        var text = document.getElementById("textQ2");
        text.classList.toggle("dark-background");
        text.classList.toggle("dark-text");
        var text = document.getElementById("cardQ4");
        text.classList.toggle("darkcard-background");
        text.classList.toggle("dark-text");

        var text = document.getElementById("link1");
        text.classList.toggle("dark-text");
        var text = document.getElementById("link2");
        text.classList.toggle("dark-text");
        var text = document.getElementById("link3");
        text.classList.toggle("dark-text");
        var text = document.getElementById("link4");
        text.classList.toggle("dark-text");
